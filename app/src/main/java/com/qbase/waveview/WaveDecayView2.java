 ...
 */
public class WaveDecayView2 extends View {
    ...
    public WaveDecayView2(Context context) {
        this(context, null);
    }

    public WaveDecayView2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
        init(context, attrs);
    }

    public WaveDecayView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public WaveDecayView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
